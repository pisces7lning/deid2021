...
date_pattern = '(1[0-2]|0?[1-9])/(3[01]|[12][0-9]|0?[1-9])' # regular expression for m/d or mm/dd

# compiling the reg_ex would save same time!
...
def deid_date(text_path='id.text', output_path='date-xueyun-liu.phi'):
    """
    Inputs:
        ...
        with open(text_path) as text:
            ...
            for line in text:
                ...
                if len(record_end):
                    ...
                    # pass all to check_for_date to find any data year in note.
